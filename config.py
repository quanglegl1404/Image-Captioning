...
class Config(object):
    ...
    machine_output_path = './data/july_7_v1_machine_output.json'
    threshold = 1
    ...
    encoder_path = "./checkpoints/july5/encoder_epoch15-july-5"
    decoder_path = "./checkpoints/july5/decoder_epoch15-july-5"