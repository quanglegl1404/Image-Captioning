...
class Config(object):
    ...
    machine_output_path = './data/july_28_v2_machine_output_vie_bert.json'
    threshold = 1
    ...
    encoder_path = "./checkpoints/encoder_11_july_28_vie_bert.ckpt"
    decoder_path = "./checkpoints/decoder_11_july_28_vie_bert.ckpt"