...
class Config(object):
    ...
    machine_output_path = './data/july_9_v2_baseline_machine_output.json'
    threshold = 1
    ...
    encoder_path = "./checkpoints/july7_bert/encoder_epoch16_july_8_baseline"
    decoder_path = "./checkpoints/july7_bert/decoder_epoch16_july_8_baseline"