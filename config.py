...
class Config(object):
    ...
    machine_output_path = './data/july_16_v2_machine_output_baseline_20.json'
    threshold = 1
    ...
    encoder_path = "./checkpoints/encoder_20_july_15_vie_baseline.ckpt"
    decoder_path = "./checkpoints/decoder_20_july_15_vie_baseline.ckpt"