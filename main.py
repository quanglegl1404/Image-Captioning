    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        try:
            ...
            #print(f"min losses: {min_losses}")
                    ...
                    # print('model saved')
            print(f'Loss: {loss}')
            torch.save(decoder.state_dict(),'./checkpoints/decoder_'+str(epoch+1)+'_july_20_vie_base.ckpt')
            torch.save(decoder.state_dict(),'./checkpoints/encoder_'+str(epoch+1)+'_july_20_vie_base.ckpt')
